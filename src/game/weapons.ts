...
export const WEAPONS: Record<string, WeaponDef> = {
  ...
  glock: {
    ...
    fireRate: 0.12,
    ammo: 20, maxAmmo: 20, reserveAmmo: 120,
  ...
  usp: {
    ...
    fireRate: 0.15,
    ammo: 12, maxAmmo: 12, reserveAmmo: 24,
  ...
  p250: {
    ...
    fireRate: 0.14,
    ammo: 13, maxAmmo: 13, reserveAmmo: 26,
  ...
  deagle: {
    ...
    fireRate: 0.45,
    ammo: 7, maxAmmo: 7, reserveAmmo: 35,
  ...
  mac10: {
    ...
    fireRate: 0.075,
    ammo: 30, maxAmmo: 30, reserveAmmo: 100,
  ...
  p90: {
    ...
    armorPenetration: 0.6,
    fireRate: 0.07,
    ammo: 50, maxAmmo: 50, reserveAmmo: 100,
  ...
  m4a1s: {
    ...
    armorPenetration: 0.85,
    fireRate: 0.1,
    ammo: 20, maxAmmo: 20, reserveAmmo: 40,
  ...
  galil: {
    ...
    armorPenetration: 0.75,
    fireRate: 0.09,
    ammo: 35, maxAmmo: 35, reserveAmmo: 90,
  ...
  famas: {
    ...
    armorPenetration: 0.75,
    fireRate: 0.09,
    ammo: 25, maxAmmo: 25, reserveAmmo: 90,
  ...
  ssg08: {
    ...
    armorPenetration: 0.9,
    fireRate: 1.25,
    ammo: 10, maxAmmo: 10, reserveAmmo: 90,
  ...
  knife: {
    ...
    damage: 55,
    headshotDamage: 180, // Backstab
    armorPenetration: 1.0,
    fireRate: 0.5,
    ammo: Infinity, maxAmmo: Infinity, reserveAmmo: 0,
